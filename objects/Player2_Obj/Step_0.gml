// Buffer activate
if(keyboard_check(global.P2_Attack)){
	Abuffer = global.bufferAmount;
}
else if(keyboard_check(global.P2_Special)){
	Sbuffer = global.bufferAmount;
}
if(keyboard_check_pressed(global.P2_Down)){
	Dbuffer = 16;
}

// Buffer cancel
if(keyboard_check_pressed(global.P2_Block)){
	Abuffer = 0;
	Sbuffer = 0;
}
